...
| DSLT 1 §"The RLCT measures the effective dimensionality" + WBIC | `dslt1-wbic-vs-bic` | Toy regular K = w² + w² vs toy singular K = w₁² w₂² | Side-by-side BIC vs WBIC as n grows; predict-then-reveal which model "wins" at each n | drafted | |
