...
- **Chapters complete:** 0
- **Currently being drafted:** `dslt1-bayes-loss-landscape` shipped
  as a single-file standalone widget at
  `chapters/dslt1-rlct-effective-dimension/widgets/01-bayes-loss-landscape.html`
  and marked drafted; rest of DSLT 1 module breakdown is proposed
  and awaiting human approval before subsequent modules begin
- **Blockers:** none
