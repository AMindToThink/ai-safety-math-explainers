...
| §4.2 Provability induction (Ramanujan/Hardy) | `li-ch3-provability-induction` | 20 EC theorems with proof-length f(n); side-by-side heatmaps for the no-LI vs LI Hardy | Pick f-growth (linear/quadratic/cubic); identify whether LI's trust-threshold N★ depends on f | drafted | _pending_ |
