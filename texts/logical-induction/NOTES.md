...
| §4.1 Limit coherence (the three Gaifman conditions) | `li-ch3-limit-coherence` | Three minimal counterexamples: T⊢φ but p<1; T⊢¬φ but p>0; T⊢¬(φ∧ψ) but linearity broken | Tabbed scenario picker per Gaifman condition; ε-amplitude slider; trader earns ε/day post D-proof in each | drafted | _pending_ |
