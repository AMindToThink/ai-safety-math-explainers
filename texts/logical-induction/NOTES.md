...
| §4.3 Statistical-pattern learning | `li-ch3-pi-statistical` | π-digit prediction; `(π[Ack(n,n)]=7)_n` | Compare three hypothetical reasoners' price trajectories; predict the limit price (≈ 0.1) of the inductor when digits are pseudorandom | drafted | [#21](https://github.com/AMindToThink/ai-safety-math-explainers/issues/21) |
