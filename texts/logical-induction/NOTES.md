...
| §3.2 Deductive processes | `li-ch2-deductive-process` | Tiny PA-fragment deductive process; `dt_n` as theorems-provable-in-≤n-chars | Drag n; predict which p.c.-worlds get ruled out at each step; identify the day at which `dt_n` rules out an irrational world | drafted | _pending_ |
