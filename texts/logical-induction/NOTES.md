...
| §3.5 Exploitation + arbitrage example | `li-ch2-arbitrage-pair` | RH ∨ ¬RH provable disjunction; trader buys 10 of each at 20¢/30¢ each day | Slider for t★ (day D emits the disjunction); reader predicts whether the trader exploits regardless of t★ | drafted | _pending_ |
